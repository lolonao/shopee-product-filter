...
### ISSUE #29: プレビューと計算ツールの連携強化

-   [ ] **プレビューからの価格連携:** Streamlitアプリの「登録済み商品検索」のプレビュー結果に「この価格で仕入れ価格を計算」ボタンを設置する。ボタンをクリックすると、その商品の価格と国情報が下部の「最低仕入れ価格 計算ツール」に自動的にセットされるようにする。
